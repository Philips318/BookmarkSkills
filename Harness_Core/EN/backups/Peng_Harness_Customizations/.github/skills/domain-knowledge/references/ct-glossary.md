...
| Term | Full Name | Unit | Description |
|------|-----------|------|-------------|
...
| **IPP** | Image Position Patient | mm | 3D coordinates (x,y,z) of top-left pixel in patient space |
...
| Mode | Description |
|------|-------------|
| **Axial** | Step-and-shoot; table stops during each rotation |
| **Helical** | Continuous table movement during rotation; most common |
| **Cardiac** | ECG-gated; Step & Shoot or Helical with phase selection |
| **Composite** | Multiple scan ranges in one exam |
| **Interventional** | Real-time guidance during procedures |
| **Surview/Scout** | Low-dose projection for scan planning (not for diagnosis) |

## Patient Positions (8 standard)

| Code | Full Name | Axial IOP |
|------|-----------|-----------|

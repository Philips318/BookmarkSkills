...
Severity, Occurrence, and Detection evaluation criteria for Philips CT Design FMEA.

---

## Severity — Design FMEA

Estimated severity of end effect on user.

| Level | Name | Evaluation Criteria | Detailed Explanation |
|-------|------|---------------------|----------------------|
| **S** | **Safety** | Safety-related failure | Refer to Hazard List. Potential harm to patient or user. |
...
Use these standard phrases in the **End Effect of Failure** column:

| Severity | Standard Phrases |
|----------|-----------------|
...
Estimated probability of occurrence per lifetime of the product, based on current controls on prevention.

Results of e.g. design review, analysis, simulation, testing, following standards, or yield, customer complaints, failure history.

| Level | Name | Evaluation Criteria | Likely Failure Rates |
|-------|------|---------------------|---------------------|
...
> *Mentioned failure rates are default, but can be business and product specific.*

### Occurrence Rating Guidelines for CT Software

| Scenario | Suggested Rating |
|----------|-----------------|
...
Estimated probability of detection, based on current controls on detection.

Testing on this, or a comparable failure mechanism, used to characterize the cause and/or potential failure mode and detect the failure mode before the design is released for production.

| Level | Name | Evaluation Criteria |
|-------|------|---------------------|
...
| Detection Method | Suggested Rating |
|-----------------|-----------------|

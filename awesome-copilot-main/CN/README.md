#🤖Awesome GitHub Copilot[![由超级副驾驶驱动](https://img.shields.io/badge/Powered_by-Awesome_Copilot-blue?logo=githubcopilot)](https://aka.ms/awesome-github-copilot) [！[GitHub贡献者来自allcontributors.org](https://img.shields.io/github/all-contributors/github/awesome-copilot?color=ee8449)]（#贡献者-）

一个社区创建的自定义代理、说明、技能、挂钩、工作流和插件的集合，以增强您的GitHub Copilot体验。

> [!提示)
> **在网站上浏览完整的集合→** [awesome-copilot.github.com]（https://awesome-copilot.github.com）
>
该网站提供全文搜索和过滤数百种资源，加上MCP服务器和开发人员工具的[工具]（https://awesome-copilot.github.com/tools）部分，以及指南和教程的[学习中心]（https://awesome-copilot.github.com/learning-hub）。
>
b> **在AI代理中使用这个集合？**机器可读的[`llms.txt`]（https://awesome-copilot.github.com/llms.txt）包含所有代理、指令和技能的结构化列表。

📖学习中心对GitHub Copilot定制不熟悉？网站上的**[学习中心](https://awesome-copilot.github.com/learning-hub)**提供策划文章，演练和参考材料-涵盖了从核心概念，如代理，技能和操作指南到钩子，代理工作流，MCP服务器和Copilot编码代理的所有内容。

这个仓库里有什么

|资源|描述|浏览||----------|-------------|--------|
|🤖[Agents](docs/README.agents.md) |与MCP服务器集成的专用副驾驶代理| [All Agents→](https://awesome-copilot.github.com/agents) |
|📋[指令](docs/README.instructions.md) |按文件模式自动应用的编码标准|[所有指令→](https://awesome-copilot.github.com/instructions) |
|🎯[技能](docs/README.skills.md) |包含说明和捆绑资产的文件夹|[所有技能→](https://awesome-copilot.github.com/skills) |
|🔌[插件](docs/README.plugins.md) |为特定工作流策划的代理和技能包|[所有插件→](https://awesome-copilot.github.com/plugins) |
|🪝[钩子](docs/README.hooks.md) |副驾驶座席会话期间触发的自动动作|[所有钩子→](https://awesome-copilot.github.com/hooks) |
|⚡[代理工作流](docs/README.workflows.md) |人工智能驱动的GitHub Actions自动化编写的markdown |[所有工作流→](https://awesome-copilot.github.com/workflows) |
|🍳[Cookbook](cookbook/README.md) |复制粘贴准备的食谱与Copilot api | - |

##推荐️工具想知道如何使用Awesome Copilot？查看网站的**[工具部分](https://awesome-copilot.github.com/tools)**，了解MCP服务器、编辑器集成和其他开发人员工具，以充分利用此集合。

##安装插件

对于大多数用户来说，**Awesome Copilot**市场已经在CopilotCLI/VS代码中注册，因此您可以直接安装插件：```bash
copilot plugin install <plugin-name>@awesome-copilot
```
如果您使用的是较旧的Copilot CLI版本或自定义设置，并看到市场未知的错误，请注册一次然后安装：```bash
copilot plugin marketplace add github/awesome-copilot
copilot plugin install <plugin-name>@awesome-copilot
```
# #贡献

人工智能主体引导参见[CONTRIBUTING.md]（CONTRIBUTING.md）·[AGENTS.md]（AGENTS.md）·[安全]（SECURITY.md）·[行为准则]（CODE_OF_CONDUCT.md）

>这里的自定义来自第三方开发人员。请在安装前检查任何代理及其文件。

##贡献者✨

感谢这些了不起的人（[表情符号键]（./CONTRIBUTING.md#贡献者-认可））：<!-- ALL-CONTRIBUTORS-LIST:START - Do not remove or modify this section -->
...
- [VS Code副驾驶定制文档](https://code.visualstudio.com/docs/copilot/copilot-customization) -微软官方文档
- [GitHub Copilot聊天文档](https://code.visualstudio.com/docs/copilot/chat/copilot-chat) -完整的聊天功能指南
—[VS CodeSettings]（https://code.visualstudio.com/docs/getstarted/settings）—一般VS Code配置指南

##™️商标

本项目可能包含项目、产品或服务的商标或标识。微软授权使用
商标或徽标受制于并必须遵循

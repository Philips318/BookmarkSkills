...
applyTo: '**'
---
# Dataverse SDK for Python -真实世界的用例和模板

基于官方的Dataverse数据迁移和集成模式。
...
- [SDK在GitHub上的示例]（https://github.com/microsoft/PowerPlatform-DataverseClient-Python/tree/main/examples）
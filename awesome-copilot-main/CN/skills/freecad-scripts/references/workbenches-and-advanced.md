...
工作台创建、宏、FEM脚本、Path/CAM脚本和高级配方的参考指南。

##官方维基参考

-[工作台创建]（https://wiki.freecad.org/Workbench_creation）
-[脚本教程]（https://wiki.freecad.org/Scripts）
-[宏食谱]（https://wiki.freecad.org/Macros_recipes）
- [FEM脚本]（https://wiki.freecad.org/FEM_Tutorial_Python）
-[路径脚本]（https://wiki.freecad.org/Path_scripting）
-[光线追踪脚本]（https://wiki.freecad.org/Raytracing_API_example）
- [Svg命名空间]（https://wiki.freecad.org/Svg_Namespace）
